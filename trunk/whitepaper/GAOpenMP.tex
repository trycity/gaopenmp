...
\documentclass[aps,prl,preprint,groupedaddress,showkeys,twocolumn,nobibnotes]{revtex4-1}
...
%Title of paper
\title{Multi-Dimensional Genetic Algorithm using OpenMP}
